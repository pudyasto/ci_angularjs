...
function del_data(idemp){
    var r=confirm("Lanjutkan menghapus data ?");
    if (r===true)
      {
          $.ajax({
                type: "POST",
...
<div class="box box-primary">
    <div class="box-header">
      ...
      <div class="box-footer">
        <button data-toggle="modal" data-target="#mod_add_emp" data-backdrop="static" class="btn btn-primary">Tambah</button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <button class="btn btn-primary" type="button" onclick="submit_data();">Simpan</button>
            <button class="btn btn-default" type="button" data-dismiss="modal" aria-hidden="true" onclick="cancel();">Tutup</button>
        </div>
        <?php echo form_close(); ?>
      </div>
    </div>
